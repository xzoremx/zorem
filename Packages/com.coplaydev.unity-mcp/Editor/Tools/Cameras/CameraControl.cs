    ...
    internal static class CameraControl
    {
        internal static object ListCameras(JObject @params)
        {
            ...
            if (CameraHelpers.HasCinemachine)
            {
                ...
                foreach (Component cm in allCm)
                {
                    ...
                    cameraList.Add(new
                    {
                        instanceID = cm.gameObject.GetHashCode(),
                        name = cm.gameObject.name,
                        isLive = isLive is bool b && b,
                        priority,
                        follow = follow != null ? new { name = follow.gameObject.name, instanceID = follow.gameObject.GetHashCode() } : null,
                        lookAt = lookAt != null ? new { name = lookAt.gameObject.name, instanceID = lookAt.gameObject.GetHashCode() } : null,
            ...
            foreach (var cam in unityCameras)
            {
                ...
                {
                    instanceID = cam.gameObject.GetHashCode(),
                ...
                if (brain != null)
                {
                    ...
                    if (activeCam != null)
                    {
                        ...
                        if (activeCam is Component activeComp)
                            activeID = activeComp.gameObject.GetHashCode();
                    }
                    ...
                    brainInfo = new
                    {
                        ...
                        instanceID = brain.gameObject.GetHashCode(),
        ...
        internal static object GetBrainStatus(JObject @params)
        {
            ...
            if (activeCam != null)
            {
                ...
                if (activeCam is Component comp)
                    activeID = comp.gameObject.GetHashCode();
            }
        ...
        internal static object SetBlend(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = brain.gameObject.GetHashCode() }
            };
        }
        ...
        internal static object ForceCamera(JObject @params)
        {
            ...
            if (method == null)
            {
                ...
                return new
                {
                    ...
                    data = new { instanceID = cmCamera.gameObject.GetHashCode(), method = "priority" }
                };
            }
            ...
            return new
            {
                ...
                data = new
                {
                    instanceID = cmCamera.gameObject.GetHashCode(),
