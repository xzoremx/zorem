    ...
    internal static class CameraConfigure
    {
        ...
        internal static object SetBasicCameraTarget(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = go.GetHashCode() }
            };
        }
        ...
        internal static object SetBasicCameraPriority(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = go.GetHashCode(), depth }
            };
        }
        ...
        internal static object SetCinemachineTarget(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = cmCamera.gameObject.GetHashCode() }
            };
        }
        ...
        internal static object SetCinemachinePriority(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = cmCamera.gameObject.GetHashCode(), priority }
            };
        }
        ...
        internal static object SetBody(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = go.GetHashCode(), body = bodyComponent.GetType().Name }
            };
        }
        ...
        internal static object SetAim(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = go.GetHashCode(), aim = aimComponent.GetType().Name }
            };
        }
        ...
        internal static object SetNoise(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = go.GetHashCode(), added }
            };
        }
        ...
        internal static object AddExtension(JObject @params)
        {
            ...
            return new
            {
                ...
                data = new { instanceID = go.GetHashCode(), extensionType = extTypeName }
            };
        }
